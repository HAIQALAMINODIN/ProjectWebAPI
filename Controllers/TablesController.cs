...
namespace RestaurantManagement.Controllers
{
    ...
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(tables); // Returns the list view of customers
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            return View(table); // Returns the details view of a specific table
        }
        ...
        {
            return View(); // Returns the view for creating a new table
        }
